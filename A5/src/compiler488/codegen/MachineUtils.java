...
public class MachineUtils {
    ...
    public static ArrayList<Short> scopeLines = new ArrayList<Short>();
    /**
    ...
    public static ArrayList<Instruction> whileDo(ArrayList<Instruction> condition, ArrayList<Instruction> block) {
        ...
        ArrayList<Instruction> gotoEnd = new ArrayList<>();
        gotoEnd.add(new Instruction(Machine.PUSH, programOffset));
        gotoEnd.add(new Instruction(Machine.BF));

        short gotoEndLines = (short)numLines(gotoEnd);

        short startLine = (short)(programOffset - conditionLines - blockLines - gotoEndLines - 3);

        ArrayList<Instruction> gotoCondition = new ArrayList<>();
        gotoCondition.add(new Instruction(Machine.PUSH, startLine));
        gotoCondition.add(new Instruction(Machine.BR));

        ArrayList<Instruction> loop = new ArrayList<>();
        loop.addAll(condition);
        loop.addAll(gotoEnd);
        loop.addAll(block);
        loop.addAll(gotoCondition);
